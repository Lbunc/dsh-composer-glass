...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      // It hugs its content instead of the shipped full-width row; the top
      // margin keeps the chip clear of the composer card directly above (the
      // halo is downward-only for the same reason), and `overflow:hidden` clips
      // the pills' hover backgrounds to the chip's rounded ends.
